  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 w-full max-w-full overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <div className="relative w-full sm:w-auto">
              ...
              <input
                ...
                autoComplete="off"
                className="w-full sm:w-auto pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
              />
            </div>
      ...
      <div className="overflow-hidden">
        ...
        {/* Table Body */}
        <div className="overflow-x-auto overflow-y-auto" style={{ height: '32vh', minHeight: 200 }}>
          <table className="w-full min-w-[640px]">
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {data.map((item, rowIndex) => (
                ...
                >
                  {columns.map((column) => (
                    <td key={column.key} className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm text-gray-900 dark:text-white">
