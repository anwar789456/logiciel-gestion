...
const EditFormProduct = ({ product, onClose, onSuccess }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 flex flex-col h-full" style={{ maxHeight: 'calc(90vh - 40px)' }}>
      <div className="flex-1 overflow-y-auto pr-0 pb-1 border-b border-gray-800 dark:border-gray-200 ">
        {error && (
